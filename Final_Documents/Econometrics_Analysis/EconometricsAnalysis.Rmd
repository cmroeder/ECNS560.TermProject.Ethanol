...
### Descriptive regression analysis, as a first step toward causal inference
### Predictive analysis
## Motivation
...
For selecting covariates, we use Lasso regression model. Before training the model, we 
